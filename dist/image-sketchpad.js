(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ImageSketchpad = factory());
  ...
  var downloadFile = download.exports;
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  fileExtensionMatch = fileName.match(/\.(png|jpg|jpeg)$/);
                  fileExtension = fileExtensionMatch ? fileExtensionMatch[1] : 'png';
                  fileName = fileName.replace(String(fileExtension), "sketch.".concat(String(fileExtension)));
                  return _context4.abrupt("return", this.mergeImageWithSketch(originalSize).then(function (b64) {
                    downloadFile(b64, fileName, "image/".concat(String(fileExtension)));
                    return b64;
                  }));
